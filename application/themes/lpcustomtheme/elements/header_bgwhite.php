...
?>
<nav class="navbar navbar-expand-lg navbar-dark d-none d-xl-block bg-white">
    <div class="container">

        <div class="navbar-left">
            <a class="navbar-brand" href="/">
                <img class="logo-dark w-250" src="<?php echo $view->getThemePath() ?>/assets/images/logo-simply-hooked-rgb.svg" alt="logo">
                <img class="logo-light w-250" src="<?php echo $view->getThemePath() ?>/assets/images/logo-simply-hooked-rgb.svg" alt="logo">
            </a>
        </div>
        <p class="m-0 p-0">|</p>
...
<nav class="navbar navbar-expand-lg navbar-dark d-xl-none bg-white">
    <div class="container">
        <div class="navbar-left">
            <a class="navbar-brand" href="/">
                <img class="logo-dark" src="<?php echo $view->getThemePath() ?>/assets/images/logo-simply-hooked-rgb.svg" alt="logo">
                <img class="logo-light" src="<?php echo $view->getThemePath() ?>/assets/images/logo-simply-hooked-rgb.svg" alt="logo">
            </a>
        </div>
        <div class="d-block">
